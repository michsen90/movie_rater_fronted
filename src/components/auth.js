    ...
    return (
        <div className="App">
            ...
            <div className="login-container">
                ...
                <input id="username" placeholder="username" type="text" value={username} onChange={evt => setUsername(evt.target.value)}/><br/>
                <label htmlFor="password">Password</label><br/>
                <input id="password" placeholder="password" type="password" value={password} onChange={evt => setPassword(evt.target.value)}/><br/>
                { isLoginView ? 
